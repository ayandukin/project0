                                ...
                                case "orders by site":
                                    do
                                    {
                                        ...
                                        switch (input)
                                        {
                                            ...
                                            case "Dallas":
                                            case "Fort Worth":
                                                var w = ar.OrderHistoryByLocation(input).ToList();
                                                foreach (var item in w)
                                                {
                                                    Console.WriteLine($"Order number:{item.OrderId} by customer {ar.GetCustomerName(item.Customer).FirstName} {ar.GetCustomerName(item.Customer).LastName} for ${item.Price} purchased at {item.Location} on {item.PurchaseDate}");
                                    ...
                                    do
                                    {
                                        ...
                                        switch (input)
                                        {
                                            ...
                                            default:
                                                ...
                                                if (name.Length == 2)
                                                {
                                                    if (ar.CheckCustomer(name[0], name[1]))
                                                    {
                                                        var w = ar.OrderHistoryByCustomer(name[0], name[1]);
                                                        foreach (var item in w)
                                                        {
                                                        ...
                                                        switch (input)
                                                        {
                                                            case "done":
                                                                foreach (var y in orderItems)
                                                                    Console.WriteLine(y);
                                                                var x = ar.Purchase(name[0], name[1], location, orderItems);
                                                            ...
                                                            default:
                                                                try
                                                                {
                                                                    ...
                                                                    try
                                                                    {
                                                                        if (ar.CheckInventory(location, s[0], i))
                                                                        {
                                ...
                                case "check inventory":
                                    do
                                    {
                                        ...
                                        switch (input)
                                        {
                                            ...
                                            case "Dallas":
                                            case "Fort Worth":
                                                var items = ar.DisplayInventory(input);
                                                foreach (var x in items)
