...
namespace Armory.DataAccess
{
    ...
    /// The repository is  as there is no reason to create multiple objects of this class;  methods always callable
    /// </summary>
    public  class ArmoryRepo
    {
        
        private  readonly ILogger logger = LogManager.GetCurrentClassLogger();

        private  DbContextOptions<ArmoryDbContext> options = new DbContextOptionsBuilder<ArmoryDbContext>()
                .UseSqlServer(SecretConfiguration.ConnectionString).Options;
        private ArmoryDbContext _dbContext;
        public ArmoryRepo()
        {
            _dbContext = new ArmoryDbContext(options);
        }
        ...
        public  IEnumerable<Entities.Orders> OrderHistoryByLocation(string location)
        {
        ...
        /// <returns>Collection of orders, each with a collection of corresponding invoices</returns>
        public  IEnumerable<Entities.Orders> OrderHistoryByCustomer(string first, string last)
        {
        ...
        public  IEnumerable<Entities.Item> DisplayItems()
        {
        ...
        public  IEnumerable<Entities.Inventory> DisplayInventory(string location)
        {
        ...
        public  bool CheckInventory(string location, string item, int number)
        {
        ...
        /// <returns></returns>
        public  Orders Purchase (string first, string last, string location, Dictionary<string, int> purchase)
        {
        ...
        /// <param name="item">item name</param>
        /// <param name="number">quantity</param>
        private  void ReduceInventory(string location, string item, int number)
        {
            Inventory inv = _dbContext.Inventory.First(x => x.Item == item && x.Location == location);
            inv.Quantity -= number;
            _dbContext.SaveChanges();
        ...
        /// </summary>
        /// <param name="location">store location</param>
        public  void Restock(string location)
        {
        ...
        public  bool CheckCustomer(string first, string last)
        {
